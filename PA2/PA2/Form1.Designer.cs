...
namespace PA2
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            // styling sa txtOutput (Label used for full-box coloring & centered text)
            txtOutput.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Right;
            txtOutput.BackColor = Color.FromArgb(37, 37, 38);
            txtOutput.Font = new Font("JetBrains Mono", 14F, FontStyle.Bold);
            ...
            txtOutput.AutoEllipsis = true;

            // combining all for Form1
